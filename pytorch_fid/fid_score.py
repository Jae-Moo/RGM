...
parser.add_argument('--path', type=str, default=['cifar10_train_stat.npy', '../train_logs/cifar10/dswd_lmbda_1/generated_samples'], help=('Paths to the generated images or to .npz statistic files'))
